...
function refresh(){		
	...
	$('#tenglish').html(calcTime(date,1).format('MM-dd hh:mm:ss'));	
	$('#tgermany').html(calcTime(date,2).format('MM-dd hh:mm:ss'));	
	$('#tfrance').html(calcTime(date,2).format('MM-dd hh:mm:ss'));	
	$('#tspain').html(calcTime(date,2).format('MM-dd hh:mm:ss'));	
	$('#titaly').html(calcTime(date,2).format('MM-dd hh:mm:ss'));
