...
//AvailableToDate您可进行查找的最近日期，格式为 ISO8601。  
...
echo '<pre>';
$this->invokeGetReportCount($service, $request);
...
/**
  ...
  */
 public  function invokeGetReportCount(\MarketplaceWebService_Interface $service, $request) 
  {
      try {
