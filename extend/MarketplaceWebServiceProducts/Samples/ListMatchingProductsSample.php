...
class  ListMatchingProductsSample{
...
$data['MarketplaceId']='ATVPDKIKX0DER';
 ...
 $request = new \MarketplaceWebServiceProducts_Model_ListMatchingProductsRequest($data);
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 // die;
$data=$this->invokeListMatchingProducts($service, $request);
  dump(xmltoarr($data));
/**
